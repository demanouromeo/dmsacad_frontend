            ...
            <div className="flex  flex-col-reverse md:flex-row justify-center items-center">
                ...
                <div className="md:ml-4 flex flex-col space-y-4">
                    {experiences.map((expericence) => (
                        <div
                            key={expericence.id}
                            className="flex flex-col bg-base-200 p-5 rounded-xl shadow-md shadow-primary/20 hover:shadow-primary transition-shadow duration-300"
                        >
                            ...
                            <ul className="list-disc ml-16 mt-2 text-left">
