      ...
      <div className="  flex justify-center items-center ">
        ...
        <div className="md:ml-4 space-y-4">
          {aboutSections.map((section) => (
            <div
              key={section.id}
              className="flex flex-col md:flex-row items-center bg-base-100 p-5 rounded-xl md:w-96 shadow-md shadow-primary/20 hover:shadow-primary transition-shadow duration-300 mb-6"
            >
