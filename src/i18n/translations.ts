...
export const staffManagerTranslations = {
  fr: {
    ...
    detailsMatriculeLabel: "Matricule",
    ...
    detailsDobLabel: "Date de naissance",
    detailsPobLabel: "Lieu de naissance",
  ...
  en: {
    ...
    tableHeaderNameSurname: "Name & Surname",
    ...
    detailsDobLabel: "Date of birth",
    detailsPobLabel: "Place of birth",
...
export const reportCardManagerTranslations = {
  fr: {
    ...
    tableHeaderMoyenneAnnual: "Moyenne annuelle",
  ...
  en: {
    ...
    tableHeaderMoyenneAnnual: "Annual average",
...
export const timetableHubTranslations = {
  fr: {
    ...
    individualStaffMenuBtn: "Voir l'emploi de temps individuel du personnel",
    individualStaffDialogTitle: "Emploi du temps individuel du personnel",
    individualStaffSelectLabel: "Membre du personnel",
    individualStaffNoSelection: "Sélectionner un membre du personnel",
    individualStaffExportOneLabel: "Exporter l'emploi du temps sélectionné",
    individualStaffExportPdfBtn: "PDF",
  ...
  en: {
    ...
    individualStaffMenuBtn: "View staff individual time table",
    individualStaffDialogTitle: "Staff individual time table",
    individualStaffSelectLabel: "Staff member",
    individualStaffNoSelection: "Select a staff member",
    individualStaffExportOneLabel: "Export the selected time table",
    individualStaffExportPdfBtn: "PDF",
    individualStaffExportExcelBtn: "Excel",
...
export const joursManagerTranslations = {
  fr: {
    ...
    closeBtn: "Fermer",
    saveAllTooltip: "Enregistrer toutes les modifications",
    saveAllSuccess: "Tous les jours ont été enregistrés avec succès.",
    saveAllPartialFailure: (failedCount: number) =>
      `Échec de l'enregistrement pour ${failedCount} jour(s). Les autres ont été enregistrés.`,
    deleteAllTooltip: "Supprimer tous les jours",
    deleteAllConfirmMessage:
      "Supprimer tous les jours ? Toutes les périodes déjà planifiées seront également supprimées. Cette action est irréversible.",
    deleteAllSuccess: "Tous les jours ont été supprimés avec succès.",
    deleteAllPartialFailure: (failedCount: number) =>
      `Échec de la suppression pour ${failedCount} jour(s). Les autres ont été supprimés.`,
  },
  en: {
    title: "School days",
    ...
    closeBtn: "Close",
    saveAllTooltip: "Save all changes",
    saveAllSuccess: "All days were saved successfully.",
    saveAllPartialFailure: (failedCount: number) =>
      `Failed to save ${failedCount} day(s). The others were saved.`,
    deleteAllTooltip: "Delete all days",
    deleteAllConfirmMessage:
      "Delete every day? Every period already scheduled will also be removed. This action cannot be undone.",
    deleteAllSuccess: "All days were deleted successfully.",
    deleteAllPartialFailure: (failedCount: number) =>
      `Failed to delete ${failedCount} day(s). The others were deleted.`,
  },
};
...
export const classeSubjectSettingsManagerTranslations = {
  fr: {
    ...
    saveAllBtn: "Enregistrer tout",
    saveAllTooltip: "Enregistrer toutes les modifications",
    saveAllSuccess: "Toutes les modifications ont été enregistrées avec succès.",
    saveAllFailure: "Échec de l'enregistrement d'au moins une matière.",
  ...
  en: {
    ...
    saveAllBtn: "Save all",
    saveAllTooltip: "Save all",
    saveAllSuccess: "All changes were saved successfully.",
    saveAllFailure: "Failed to save at least one subject.",
